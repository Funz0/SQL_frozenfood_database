...
--
-- Host: 127.0.0.1    Database: frozenfood
-- ------------------------------------------------------
...
INSERT INTO `customerorder` VALUES (1,22,23,2,'2021-03-25',12,3.80),(2,22,24,4,'2021-03-25',12,19.96),(3,33,14,6,'2021-03-25',12,26.94),(4,33,20,4,'2021-03-25',12,51.96),(5,11,34,4,'2021-03-25',12,89.96),(6,11,44,10,'2021-03-25',12,109.90),(7,35,1,4,'2021-03-25',12,39.96),(8,15,10,6,'2021-03-25',12,59.94),(9,25,50,3,'2021-03-25',12,44.97),(10,12,9,8,'2021-03-25',12,103.92);
...
INSERT INTO `customerpayment` VALUES (1,1,3.80,'2021-03-25 04:00:00'),(2,2,19.96,'2021-03-25 04:00:00'),(3,3,26.94,'2021-03-25 04:00:00'),(4,4,51.96,'2021-03-25 04:00:00'),(5,5,89.96,'2021-03-25 04:00:00'),(6,6,109.90,'2021-03-25 04:00:00'),(7,7,39.96,'2021-03-25 04:00:00'),(8,8,59.94,'2021-03-25 04:00:00'),(9,9,44.97,'2021-03-25 04:00:00'),(10,10,103.92,'2021-03-25 04:00:00');
...
INSERT INTO `purchaseorder` VALUES (1,1,1,10,'2021-03-25',12,99.90),(2,1,2,15,'2021-03-25',12,179.85),(3,3,8,15,'2021-03-25',12,345.00),(4,7,21,12,'2021-03-25',12,119.88),(5,9,26,20,'2021-03-25',12,730.00),(6,9,27,18,'2021-03-25',12,657.00),(7,2,34,10,'2021-03-25',12,224.90),(8,3,37,15,'2021-03-25',12,1349.85),(9,4,41,14,'2021-03-25',12,1539.86),(10,5,39,10,'2021-03-25',12,87.90);
...
INSERT INTO `suppliertransaction` VALUES (1,3,345.00,'2021-03-25 04:00:00'),(2,5,730.00,'2021-03-25 04:00:00'),(3,6,657.00,'2021-03-25 04:00:00'),(4,8,1349.85,'2021-03-25 04:00:00'),(5,9,1539.86,'2021-03-25 04:00:00');
...
BEGIN
		...
		/* declare cursor for columns productId and quanity where customer order has an order state of "Shipped" */
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `employeesupplierdetail` AS select concat(`e`.`firstName`,' ',`e`.`lastName`) AS `Representative`,`s`.`supplierName` AS `Supplier` from ((`employeesupplier` `es` join `employee` `e`) join `supplier` `s`) where ((`es`.`employeeID` = `e`.`ID`) and (`es`.`supplierID` = `s`.`ID`)) order by `e`.`lastName` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `productsupplierdetail` AS select `p`.`description` AS `Product`,`s`.`supplierName` AS `Supplier` from ((`productsupplier` `ps` join `product` `p`) join `supplier` `s`) where ((`ps`.`productID` = `p`.`ID`) and (`ps`.`supplierID` = `s`.`ID`)) order by `s`.`supplierName` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2021-04-20 17:51:11
